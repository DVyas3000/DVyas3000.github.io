...
setTimeout(() => {
  ...
  'any', 'some', 'none', 'each', 'either', 'neither', 'one', 'all', 'few', 'many', 'several', 'both', 'others',
  'each other', 'one another'
  ];

  const prepositions = ['in', 'on', 'at', 'by', 'with', 'about', 'above', 'below', 'during', 'for',
  'from', 'to', 'into', 'onto', 'over', 'under', 'through', 'between', 'among',
  'after', 'before', 'around', 'behind', 'beside', 'beneath', 'beyond', 'within',
  'without', 'across', 'against', 'along', 'near', 'inside', 'outside', 'off', 'up', 'down'
  ];
